...
import { ctaData } from "@/app/(landing)/constants"
import { ctaBanner } from "@/app/(landing)/assets"
        ...
        <div className="container">
            ...
            >
                <div className="p-8 md:p-16 xl:p-20">
                    ...
                    >
                        <Button className="bg-foreground text-background hover:bg-foreground/95">رایگان شروع کنید</Button>
                        <Button variant="outline" className="!bg-transparent border-current">تعرفه ها</Button>
                    </motion.div>
                </div>
                <motion.figure 
